...
module.exports = {
    ...
    default: () => message.reply("Adicione uma nova individualidade: *addquirk {nome: 'exemplo', descricao: 'descricaoexemplo', tipo: 'Emissão', funcao: 'Ofensiva', funcaosecundaria: 'Defensiva'}"),
