...
module.exports = {
    ...
    default: message => message.reply("Adicione uma nova individualidade através deste comando. Exemplo abaixo: \n\n*addquirk {nome: 'teste', descricao: 'teste', tipo: 'Emissão', defesa: 5, ataque:5, dodge_chance:0.1, crit_chance: 0.1, controlChance: 0.1, funcaoprimaria: 'ofensiva', funcaosecundaria: 'ofensiva'}.\n\n *funcaosecundaria É OPCIONAL!*"),
